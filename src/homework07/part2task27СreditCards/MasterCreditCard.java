...
public class MasterCreditCard extends Master {
    ...
    public MasterCreditCard(String number, String name, String surName, int cv, String affiliationBank, boolean virtual, boolean supportPayByMobilePhone,
